...
describe("NoteList component", () => {
    describe("rendering", () => {
        ...
        it('should contain a NoteView element with isSelected properties equals to the note.isSelected in the AsyncStorage', async () => {
            ...
            expect(mockResult.root.findByType(NoteView).props.isSelected).not.toBeNull();
            expect(mockResult.root.findByType(NoteView).props.isSelected).toEqual(note.isSelected);
        });
    });
    ...
    describe("long click on a note", () => {
        it('should change the isSelected to true when doing an long click on the NoteView', async () => {
            ...
            expect(mockResult.root.findByType(NoteView).props.isSelected).toEqual(true);
        });
        ...
        it('should change the isSelected to false when doing a click on a selected NoteView', async () => {
            ...
            expect(mockResult.root.findByType(NoteView).props.isSelected).toEqual(false);
        });
        ...
        it('should display the delete icon in the header when the user select a note', async () => {
            ...
            expect(mockResult.root.findByProps({testID: "btnRemoveSelectedNotes"}).length).not.toBeNull();
        ...
        it('should display hide delete icon in the header when the user unselect all notes', async () => {
            ...
            expect(mockResult.root.findAllByProps({testID: "btnRemoveSelectedNotes"}).length).toEqual(0);
        });
        ...
        it('should change allow the selection of several NoteView', async () => {
            ...
            await act(async () => {
                ...
                mockResult.root.findAllByType(NoteView)[2].props.onLongSelect(noteThree);
            });

            expect(mockResult.root.findAllByProps({isSelected: true}).length).toEqual(2);
        });
        ...
        it('should delete the selected NoteView once click on delete button', async () => {
            ...
            await act(async () => {
                mockResult.root.findByProps({testID: "btnRemoveSelectedNotes"}).props.onPress();
            });
    ...
    describe("click on a specific noteView", () => {
        ...
        it('should open the NoteEdition screen with the selected note information', async () => {
            ...
            expect(mockResult.root.findByProps({testID: "text-input-modification-note-title"}).props.value).toEqual(noteThree.title);
            expect(mockResult.root.findByProps({testID: "text-input-modification-note-description"}).props.value).toEqual(noteThree.description);
        });
    });
    ...
    describe("click on create note", () => {
        ...
        it('should open the NoteEdition screen with an empty note', async () => {
            ...
            expect(mockResult.root.findByProps({testID: "text-input-modification-note-title"}).props.value).toEqual("");
            expect(mockResult.root.findByProps({testID: "text-input-modification-note-description"}).props.value).toEqual("");
        });
    });
});